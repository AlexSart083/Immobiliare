...
TRANSLATIONS = {
    'it': {
        ...
        'cagr_nominal': '• **CAGR (Nominale): ',
        'cagr_real': '• **CAGR (Reale): ',
        ...
        ' anni senza rata': ' anni senza rata',
        ...
        'cagr_note': '- **CAGR**: Tasso di crescita annuale composto',
    ...
    'en': {
        ...
        ' anni senza rata': ' years without payments',
        ...
        'cagr_note': '- **CAGR**: Compound Annual Growth Rate',
